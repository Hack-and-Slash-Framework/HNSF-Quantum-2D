    ...
    public struct AnimationFrame
    {
        ...
        public static AnimationFrame operator +(AnimationFrame AnimationFrameA, AnimationFrame AnimationFrameB)
        {
            return new AnimationFrame()
            {
                ...
                //RotationY = AnimationFrameA.RotationY,
                rotModifier = AnimationFrameA.rotModifier + AnimationFrameB.rotModifier,
            };
        }
        ...
        public static AnimationFrame operator -(AnimationFrame AnimationFrameA, AnimationFrame AnimationFrameB)
        {
            return new AnimationFrame()
            {
                ...
                //RotationY = AnimationFrameB.RotationY,
                rotModifier = AnimationFrameB.rotModifier - AnimationFrameA.rotModifier,
            };
        }
        ...
        public static AnimationFrame operator *(AnimationFrame AnimationFrameA, FP value)
        {
            return new AnimationFrame()
            {
                ...
                //RotationY = AnimationFrameA.RotationY,
                rotModifier = AnimationFrameA.rotModifier * value,
            };
        }
        ...
        public static AnimationFrame Lerp(AnimationFrame AnimationFrameA, AnimationFrame AnimationFrameB, FP value)
        {
            ...
            output.rotModifier = FPMath.Lerp(AnimationFrameA.rotModifier, AnimationFrameB.rotModifier, value);
