...
{
    public unsafe partial class Combatbox2DBroadphaseReadQueriesSystem : SystemMainThread
    {
        ...
        private static void ReadHitboxQueries(Frame f)
        {
            ...
            {
                if (!f.Physics2D.TryGetQueryHits(hitboxQuery.queryRef, out var hitboxHits) ||
        ...
        private static void ReadCollisionboxQueries(Frame f)
        {
            ...
            {
                if (!f.Physics2D.TryGetQueryHits(collisionboxQuery.queryRef, out var collisionboxHits) ||
        ...
        private void ReadThrowboxQueries(Frame f)
        {
            ...
            {
                if (!f.Physics2D.TryGetQueryHits(throwboxQuery.queryRef, out var throwboxHits) ||
